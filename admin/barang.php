        ...
        <div class="page-container">
            ...
            <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">      
                                <h3 class="title-3 m-b-30"><i class="fas fa-users"></i>KELOLA DATA BARANG</h3>
                                  ...
                                  <form action="" method="POST" enctype="multipart/form-data">
                                   <div class="modal-body">     
                                     ...
                                     <div class="form-group">
                                         ...
                                         <input type="text" name="stok" id="stok" class="form-control" placeholder="Masukkan stok" required="true">
                                     </div>
                                      <div class="form-group">
                                         <label for="hb">Harga beli</label>
                                         <input type="text" name="hb" id="hb" class="form-control" placeholder="Masukkan harga beli" required="true">
                                     </div>

                                      <div class="form-group">
                                         <label for="hj">Harga Jual</label>
                                         <input type="text" name="hj" id="hj" class="form-control" placeholder="Masukkan harga jual" required="true">
                                     </div>
                                     <div class="form-group">
              ...
              <script type="text/javascript">
                  ...
                  database.ref("barang").orderByKey().limitToLast(1).on('child_added',function(data) {
                  ...
                  database.ref('barang').on('value', function(snapshot) {
                     ...
                     if(snapshot.exists()){
                        ...
                        snapshot.forEach(function(data) {
                           ...
                           content += '<td>' + val.harga_beli + '</td>';
                           content += '<td>' + val.harga_jual + '</td>';
                           content += '<td>' + val.id_supplier + '</td>';
                  ...
                  function tambahData(){
                     if($('#exampleModalLabel').text() == "Tambah Data Baru"){
                       ...
                       var date = new Date();
                        ...
                        var today = "BRG" + year + month + day + jam + detik + mldetik;

                       database.ref('barang/' + key).set({
                           key : key,
                           kode_barang : today,
                    ...
                    database.ref('barang/' + $('#id').val()).update({
                       nama_barang : $('#nama').val(),
                       stok : $('#stok').val(),
                       harga_beli   : $('#hb').val(),
                       harga_jual   : $('#hj').val(),
            ...
            function cleardata(){
             ...
             database.ref('supplier').on('value', function(snapshot) {
               if(snapshot.exists()){
                ...
                snapshot.forEach(function(data) {
                 var val = data.val();
                 content += '<option value="' + val.id_supplier + '">' + val.nama + '</option>';
             });
         ...
         function setData(id){
             ...
             database.ref('barang/').child(id).once('value').then( function(snap) {
                 const user = snap.val()
                 $('#id').val(id);
                 $('#nama').val(user.nama_barang);
                 $('#stok').val(user.stok);
                 $('#hb').val(user.harga_beli);
                 $('#hj').val(user.harga_jual);
                 ...
                 database.ref('supplier').on('value', function(snapshot) {
                     if(snapshot.exists()){
                        ...
                        if(user.id_supplier == val.id_supplier){

                             content += '<option value="' + val.id_supplier + '" selected>' + val.nama + '</option>';
